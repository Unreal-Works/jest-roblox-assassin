...
describe("runJestRoblox.js", () => {
    ...
    it("should run tests with valid --place file", async () => {
        const requiredMatches = [
            "demo/src/__tests__/add.spec.ts",
            ...
            "demo/src/__tests__/afolder/myCompartmentalizedTests.spec.ts",
            "demo/src/__tests__/div.spec.ts",
            "demo/src/__tests__/mul.spec.ts",
            "demo/src/__tests__/myModule.spec.ts",
            "demo/src/__tests__/sub.spec.luau",
            "fails when expecting 9 - 2 to equal 8",
            `it("fails when expecting 9 - 2 to equal 8", function()`,
            `expect(9 - 2).toBe(8)`,
            "src/__tests__/sub.spec.luau:19",
            "demo/src/anothertestproject/ilovetesting.spec.ts",
